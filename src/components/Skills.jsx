...
export default function Skills() {
  return (
    <div className="flex justify-center mt-16 sm:justify-start" id="skills">
      ...
      >
        <div className="absolute flex items-center justify-center bg-dark-yellow  border-4 border-slate-300 h-[4rem] w-[4rem] sm:h-[6rem] sm:w-[6rem] rounded-full   ">
          <img src={JS} alt="" className="h-5 sm:h-8" />
        </div>
        <div className="absolute -top-8 md:-top-10 flex items-center justify-center bg-white border-4 border-slate-300   h-[4rem] w-[4rem] sm:h-[6rem] sm:w-[6rem] rounded-full   ">
          <img src={Reactjs} alt="" className="h-10 sm:h-14" />
        </div>
        <div className="absolute -bottom-8 md:-bottom-10 flex items-center justify-center bg-white border-4 border-slate-300  h-[4rem] w-[4rem] sm:h-[6rem] sm:w-[6rem]  rounded-full   ">
          <img src={Figma} alt="" className=" h-14" />
        </div>
        <div className="absolute -left-8 sm:-left-12 flex items-center justify-center bg-white border-4 border-slate-300 h-[4rem] w-[4rem] sm:h-[6rem] sm:w-[6rem]  rounded-full   ">
          <img src={Nodejs} alt="" className=" sm:h-10" />
        </div>
        <div className="absolute -right-8 md:-right-12 flex items-center justify-center bg-white border-4 border-slate-300 h-[4rem] w-[4rem] sm:h-[6rem] sm:w-[6rem]  rounded-full   ">
          <img src={Tailwind} alt="" className=" sm:h-12" />
        </div>
      </motion.div>
